let  radialArcs = [], fft, song, soundSpectrum, myDataValue, myDataColour;
...
function draw() {
  if (song.isPlaying()) {
    ...
    myDataValue = getNewSoundDataValue("bass"); // requesting the "amplitude data for the "bass" frequency.
    myDataColour = getDataHSBColor(myDataValue);
    background(myDataColour);
    updateRadialArcs();
    drawRadialArcs();
  }
}
